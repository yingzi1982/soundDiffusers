...
set output '../psv/figures/multiImage.eps'
...
set multiplot
#-----------------------------------------------
dataFile = '../psv/0/backup/image_bv'
nrow=2
ncol=1
...
#-----------------------------------------------
dataFile = '../psv/4/backup/image_bv'
nrow=2
ncol=2
set lmargin at screen left(ncol)
set rmargin at screen right(ncol)
...
#-----------------------------------------------
dataFile = '../psv/8/backup/image_bv'
nrow=1
ncol=1
set lmargin at screen left(ncol)
set rmargin at screen right(ncol)
...
splot '< sort -g -k1 -k2 '.dataFile.' | uniq | awk -f ../bash/addblanks.awk' using(column(1)/1000):(column(2)/1000):(column(dataColumn)) with pm3d notitle
#-----------------------------------------------
dataFile = '../psv/12/backup/image_bv'
nrow=1
ncol=2
set lmargin at screen left(ncol)
set rmargin at screen right(ncol)
