...
set output '../sh/figures/multisignal.eps'
...
set xlabel 'Range (km)'
set ylabel 'Time (s)' 
stats '../sh/0/backup/combinedTrace_Y_1' using (column(1)) name 'tBench'

plot for [n=stationStartNumber:stationEndNumber] '../sh/8/backup/combinedTrace_Y_1' using(column(n+1)*scale+n):(column(1)-tBench_max/2) every 20::30000::50000 with filledcurves above x1=n linewidth 2 linecolor 7 linetype 1 title '',\
     for [n=stationStartNumber:stationEndNumber] '../sh/0/backup/combinedTrace_Y_1' using(column(n+1)*scale+n):(column(1)-tBench_max/2) every 20::30000::50000 with filledcurves above x1=n linewidth 2 linecolor 1 linetype 4 title ''
#-----------------------------------------------
unset multiplot
