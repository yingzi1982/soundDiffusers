...
set output '../sh/figures/multibackwardwavefield_fullrange.eps'
...
set multiplot
#-----------------------------------------------
dataFile = '../sh/0/backup/wavefield_30001'
nrow=2
ncol=1
...
#-----------------------------------------------
dataFile = '../sh/4/backup/wavefield_30001'
nrow=2
ncol=2
set lmargin at screen left(ncol)
set rmargin at screen right(ncol)
...
#-----------------------------------------------
dataFile = '../sh/8/backup/wavefield_30001'
nrow=1
ncol=1
set lmargin at screen left(ncol)
set rmargin at screen right(ncol)
...
splot '< sort -g -k1 -k2 '.dataFile.' | uniq | awk -f ../bash/addblanks.awk' using(column(1)/1000):(column(2)/1000):(column(dataColumn)) with pm3d notitle
#-----------------------------------------------
dataFile = '../sh/12/backup/wavefield_30001'
nrow=1
ncol=2
set lmargin at screen left(ncol)
set rmargin at screen right(ncol)
