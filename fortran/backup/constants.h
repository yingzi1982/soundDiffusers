...
! create file DATA/model_velocity.dat_output or not (can be huge and slow, thus off by default)
  logical, parameter :: OUTPUT_MODEL_VELOCITY_FILE = .true.
...
! maximum length of station and network name for receivers
  ...
  integer, parameter :: MAX_LENGTH_NETWORK_NAME = 32
...
! 1. constants.h
! 2. specfem2D.F90
! 3. prepare_source_time_function.f90

  integer, parameter :: OUTPUT_WAVEFIELD_DUMPS_MOD_X = 1
  integer, parameter :: OUTPUT_WAVEFIELD_DUMPS_MOD_Z = 1
!--------------------MODIFICATION END  -------------------------
