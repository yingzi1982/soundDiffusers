...
set output '../psv/figures/multikernel_'.colNum.'.eps'
...
stats '../psv/0/backup/normalization' using (column(colNum-2)) name 'bench'
splot '< sort -g -k1 -k2 ../psv/0/backup/kernel | uniq | awk -f ../bash/addblanks.awk' using(column(1)/1000):(column(2)/1000):(column(colNum)/bench_mean) with pm3d notitle,\
      '../psv/0/backup/STATIONS' using(column(3)/1000):(column(4)/1000):(1) with points ls 2 notitle
show cbrange
#-----------------------------------------------
nrow=2
ncol=2
...
set label '{/ZapfDingbats \110}' font ',12' at 0,-5 center front textcolor rgb 'brown'
stats '../psv/4/backup/normalization' using (column(colNum-2)) name 'bench'
splot '< sort -g -k1 -k2 ../psv/4/backup/kernel | uniq | awk -f ../bash/addblanks.awk' using(column(1)/1000):(column(2)/1000):(column(colNum)/bench_mean) with pm3d notitle,\
      '../psv/4/backup/STATIONS' using(column(3)/1000):(column(4)/1000):(1) with points ls 2 notitle
show cbrange
#-----------------------------------------------
#-----------------------------------------------
nrow=1
...
set label '{/ZapfDingbats \110}' font ',12' at 0,-5 center front textcolor rgb 'brown'
stats '../psv/8/backup/normalization' using (column(colNum-2)) name 'bench'
splot '< sort -g -k1 -k2 ../psv/8/backup/kernel | uniq | awk -f ../bash/addblanks.awk' using(column(1)/1000):(column(2)/1000):(column(colNum)/bench_mean) with pm3d notitle,\
      '../psv/8/backup/STATIONS' using(column(3)/1000):(column(4)/1000):(1) with points ls 2 notitle
show cbrange
#-----------------------------------------------
nrow=1
ncol=2
...
set label '{/ZapfDingbats \110}' font ',12' at 0,-5 center front textcolor rgb 'brown'
stats '../psv/12/backup/normalization' using (column(colNum-2)) name 'bench'
splot '< sort -g -k1 -k2 ../psv/12/backup/kernel | uniq | awk -f ../bash/addblanks.awk' using(column(1)/1000):(column(2)/1000):(column(colNum)/bench_mean) with pm3d notitle,\
      '../psv/12/backup/STATIONS' using(column(3)/1000):(column(4)/1000):(1) with points ls 2 notitle
show cbrange
#-----------------------------------------------
#-----------------------------------------------
