...
set output '../psv/figures/multiforwardwavefield.eps'
...
set label 'Horizontal' at graph textLabelXPosition,textLabelYPosition left front font ',12' textcolor rgb 'black' 
...
splot '< sort -g -k1 -k2 ../psv/0/backup/wavefield_35000 | uniq | awk -f ../bash/addblanks.awk' using(column(1)/1000):(column(2)/1000):(column(3)) with pm3d notitle,\
...
set label '{/ZapfDingbats \110}' font ',12' at 0,-5 center front textcolor rgb 'brown'
splot '< sort -g -k1 -k2 ../psv/8/backup/wavefield_35000 | uniq | awk -f ../bash/addblanks.awk' using(column(1)/1000):(column(2)/1000):(column(3)) with pm3d notitle,\
...
set label 'Vertical' at graph textLabelXPosition,textLabelYPosition left front font ',12' textcolor rgb 'black' 
set label '{/ZapfDingbats \110}' font ',12' at 0,-5 center front textcolor rgb 'brown'
splot '< sort -g -k1 -k2 ../psv/0/backup/wavefield_35000 | uniq | awk -f ../bash/addblanks.awk' using(column(1)/1000):(column(2)/1000):(column(4)) with pm3d notitle,\
      '../psv/0/backup/STATIONS' using(column(3)/1000):(column(4)/1000):(1) with points ls 2 notitle
#-----------------------------------------------
nrow=1
ncol=2
...
set label 'Vertical' at graph textLabelXPosition,textLabelYPosition left front font ',12' textcolor rgb 'black' 
set label '{/ZapfDingbats \110}' font ',12' at 0,-5 center front textcolor rgb 'brown'
splot '< sort -g -k1 -k2 ../psv/8/backup/wavefield_35000 | uniq | awk -f ../bash/addblanks.awk' using(column(1)/1000):(column(2)/1000):(column(4)) with pm3d notitle,\
      '../psv/8/backup/STATIONS' using(column(3)/1000):(column(4)/1000):(1) with points ls 2 notitle
